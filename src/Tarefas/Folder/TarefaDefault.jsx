    ...
    const enviarDadosDoFormulario = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:33331/tarefa', {
                ...
                body: JSON.stringify({ ...dadosDoFormulario, id_pasta: past }),
            });
                ...
                <div className=" space-y-4 p-4 sm:px-8 sm:py-6 lg:p-4 xl:px-8 xl:py-6 w-full">
                    ...
                    <div className=" flex items-center justify-between">
                        ...
                        <div className='flex gap-5' >
                            ...
                            <select onClick={(e) => { setParams({ ...params, perPage: e.target.value }) }} id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pr-10  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <select onClick={(e) => { setvisualize(e.target.value) }} id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pr-10  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option value="02" >lista</option>
                                <option value="01">Pin</option>
                                <option value="03" >Kanban</option>
                            </select>

                            <select onClick={(e) => { setStatus(e.target.value) }} id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pr-10  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
