...
const ArquivosTarefa = ({ tarefa, forceUpdate, setForceUpdate }) => {
    tarefa = tarefa[0]
        ...
        <div className="w-full h-full p-5">
            <div className="flex flex-col justify-between items-center w-full">
                ...
                >
                    ...
                    <span class="mx-1">Novo arquivo</span>
                </button>
                                    ...
                                    <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                                ...
                                                {arquivos && arquivos.length > 0 && arquivos.map((arquivo) => (
                                                    ...
                                                    < tr >
                                                        ...
                                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">                                                  <div className='flex  flex-col'>
