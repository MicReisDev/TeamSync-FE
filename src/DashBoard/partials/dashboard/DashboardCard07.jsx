...
function DashboardCard07() {
  return (
    <div className="rounded-tl-3xl rounded-br-3xl col-span-full xl:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
