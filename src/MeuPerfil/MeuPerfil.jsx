...
const MeuPerfil = () => {
    ...
    const pegarUsuario = async () => {
        try {
            const response = await fetch(`http://localhost:33331/usuario/${usuario.id_usuario}`, {
                method: 'get',
                headers: {
            ...
            if (response.ok) {
                ...
                setDadosDoFormulario({ ...dados, senha: '', confirmSenha: '' })
            } else {
    ...
    const enviarImagem = async (imagemSelecionada) => {
        ...
        try {
            ...
            if (response.ok) {
                const dados = await response.json();
                setDadosDoFormulario({ ...dadosDoFormulario, avatar: dados.url })
            } else {
                console.error(response);
            }
        } catch (error) {
    ...
    return <>
        ...
        <div className='flex flex-col scroll px-5 py-2 bg-white rounded-xl w-full h-full'>
            ...
            {carregarUsuario ? <Loading /> :
                <form className='flex flex-col gap-5' onSubmit={Editar}>
